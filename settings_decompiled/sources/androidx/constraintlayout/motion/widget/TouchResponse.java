...
public class TouchResponse {
    ...
    public void processTouchEvent(MotionEvent motionEvent, MotionLayout.MotionTracker motionTracker, int i, MotionScene motionScene) {
        ...
        if (action == 1) {
            this.mDragStarted = false;
            motionTracker.computeCurrentVelocity(AppStandbyOptimizerPreferenceController.TYPE_APP_WAKEUP);
            ...
            this.mMotionLayout.touchAnimateTo(i2, ((double) progress) < 0.5d ? 0.0f : 1.0f, f3);
        } else if (action != 2) {
        } else {
