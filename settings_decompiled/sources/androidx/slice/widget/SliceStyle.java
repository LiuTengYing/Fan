...
public class SliceStyle {
    ...
    public SliceStyle(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        try {
            ...
            this.mRowMinHeight = (int) obtainStyledAttributes.getDimension(R$styleable.SliceView_rowMinHeight, resources.getDimensionPixelSize(i3));
        ...
        if (gridContent.isValid()) {
            ...
            if (gridContent.isAllImages()) {
                ...
                if (largestImageMode == 4) {
                    i = gridContent.getFirstImageSize(this.mContext).y + ((z2 ? 2 : 1) * this.mGridRawImageTextHeight);
                } else if (!z2 || z) {
                    if (z3) {
                        i = this.mGridMinHeight;
                    } else {
            ...
            int i3 = (gridContent.isAllImages() && gridContent.getRowIndex() == 0) ? this.mGridTopPadding : 0;
