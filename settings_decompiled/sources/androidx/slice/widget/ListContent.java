...
public class ListContent extends SliceContent {
    ...
    private static boolean isValidHeader(SliceItem sliceItem) {
        return (!"slice".equals(sliceItem.getFormat()) || sliceItem.hasAnyHints("actions", "keywords", "see_more") || SliceQuery.find(sliceItem, "text", (String) null, (String) null) == null) ? false : true;
    }
}
