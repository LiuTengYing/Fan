...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3, NestedScrollingParent2, NestedScrollingChild {
    ...
    public void onStopNestedScroll(View view) {
        ...
        if (f > 0.0f) {
            ...
            post(new Runnable() { // from class: androidx.swiperefreshlayout.widget.SwipeRefreshLayout$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    SwipeRefreshLayout.this.lambda$onStopNestedScroll$0();
                }
            });
        }
        stopNestedScroll();
