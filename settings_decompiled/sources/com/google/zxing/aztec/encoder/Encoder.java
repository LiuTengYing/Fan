...
public final class Encoder {
    ...
    public static AztecCode encode(byte[] bArr, int i, int i2) {
        ...
        if (i2 != 0) {
            ...
            while (i13 <= 32) {
                ...
                if (size2 > i16) {
                    ...
                    int i17 = i16 - (i16 % i3);
                    if ((!z2 || bitArray2.getSize() <= i3 * 64) && bitArray2.getSize() + size <= i17) {
                        bitArray = bitArray2;
                        z = z2;
                        i4 = i15;
                        i5 = i16;
        ...
        BitArray generateCheckWords = generateCheckWords(bitArray, i5, i6);
        ...
        if (z) {
            ...
            for (int i23 = i10; i23 < i21; i23++) {
                iArr[(i21 - i23) - 1] = (i22 - i8) - 1;
                iArr[i21 + i23] = (i23 / 15) + i23 + i22 + i11;
            }
        }
        ...
        while (i24 < i4) {
            ...
            while (i28 < i27) {
                int i29 = i28 * 2;
                while (i10 < i19) {
                    if (generateCheckWords.get(i25 + i29 + i10)) {
                        int i30 = i24 * 2;
                        bitMatrix.set(iArr[i30 + i10], iArr[i30 + i28]);
                    }
                    if (generateCheckWords.get((i27 * 2) + i25 + i29 + i10)) {
                        int i31 = i24 * 2;
                        bitMatrix.set(iArr[i31 + i28], iArr[((i18 - 1) - i31) - i10]);
                    }
                    if (generateCheckWords.get((i27 * 4) + i25 + i29 + i10)) {
                        int i32 = (i18 - 1) - (i24 * 2);
                        bitMatrix.set(iArr[i32 - i10], iArr[i32 - i28]);
                    }
                    if (generateCheckWords.get((i27 * 6) + i25 + i29 + i10)) {
                        int i33 = i24 * 2;
