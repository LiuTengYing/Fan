...
import com.android.settings.applications.FreeformWindowsSettings;
...
import com.android.settings.deviceinfo.firmwareversion.SyuDeviceInfoSettings;
...
import com.android.settings.gestures.ThreePointerScreenshotSettings;
...
public class SearchIndexableResourcesBase implements SearchIndexableResources {
    ...
    public SearchIndexableResourcesBase() {
        ...
        addIndex(new SearchIndexableData(SyuDeviceInfoSettings.class, SyuDeviceInfoSettings.SEARCH_INDEX_DATA_PROVIDER));
        ...
        addIndex(new SearchIndexableData(FreeformWindowsSettings.class, FreeformWindowsSettings.SEARCH_INDEX_DATA_PROVIDER));
        addIndex(new SearchIndexableData(ThreePointerScreenshotSettings.class, ThreePointerScreenshotSettings.SEARCH_INDEX_DATA_PROVIDER));
        addIndex(new SearchIndexableData(NavigationBarSettings.class, NavigationBarSettings.SEARCH_INDEX_DATA_PROVIDER));
        addIndex(new SearchIndexableData(TimerPower.class, TimerPower.SEARCH_INDEX_DATA_PROVIDER));
