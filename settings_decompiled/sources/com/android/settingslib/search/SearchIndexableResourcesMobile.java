...
public class SearchIndexableResourcesMobile extends SearchIndexableResourcesBase {
    public SearchIndexableResourcesMobile() {
        ...
        addIndex(new SearchIndexableData(WiredScreenCastSettings.class, WiredScreenCastSettings.SEARCH_INDEX_DATA_PROVIDER));
        addIndex(new SearchIndexableData(GestureRecognitionFragment.class, GestureRecognitionFragment.SEARCH_INDEX_DATA_PROVIDER));
        addIndex(new SearchIndexableData(GestureRecognitionPlayFragment.class, GestureRecognitionPlayFragment.SEARCH_INDEX_DATA_PROVIDER));
        addIndex(new SearchIndexableData(GestureRecognitionScreenShotFragment.class, GestureRecognitionScreenShotFragment.SEARCH_INDEX_DATA_PROVIDER));
        addIndex(new SearchIndexableData(GestureRecognitionSlideScreenFragment.class, GestureRecognitionSlideScreenFragment.SEARCH_INDEX_DATA_PROVIDER));
        addIndex(new SearchIndexableData(PocketModeFragment.class, PocketModeFragment.SEARCH_INDEX_DATA_PROVIDER));
        addIndex(new SearchIndexableData(SmartControlsSettings.class, SmartControlsSettings.SEARCH_INDEX_DATA_PROVIDER));
        addIndex(new SearchIndexableData(SmartMotionFragment.class, SmartMotionFragment.SEARCH_INDEX_DATA_PROVIDER));
    }
}
