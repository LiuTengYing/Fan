...
public class BatteryStatus {
    ...
    public BatteryStatus(Intent intent) {
        ...
        if (intExtra > 0) {
            this.maxChargingWattage = (intExtra / AppStandbyOptimizerPreferenceController.TYPE_APP_WAKEUP) * (intExtra2 / AppStandbyOptimizerPreferenceController.TYPE_APP_WAKEUP);
        } else {
