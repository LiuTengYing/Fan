...
public class UserIconDrawable extends Drawable implements Drawable.Callback {
    ...
    public static Drawable getManagedUserDrawable(Context context) {
        ...
        return getDrawableForDisplayDensity(context, 17302409);
    }

    private static Drawable getUpdatableManagedUserDrawable(final Context context) {
        return ((DevicePolicyManager) context.getSystemService(DevicePolicyManager.class)).getResources().getDrawableForDensity("WORK_PROFILE_USER_ICON", "SOLID_COLORED", context.getResources().getDisplayMetrics().densityDpi, new Supplier() { // from class: com.android.settingslib.drawable.UserIconDrawable$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                Drawable drawableForDisplayDensity;
                drawableForDisplayDensity = UserIconDrawable.getDrawableForDisplayDensity(context, 17302409);
                return drawableForDisplayDensity;
            }
        });
    }
