...
public class DefaultAppInfo extends CandidateInfo {
    ...
    private ComponentInfo getComponentInfo() {
        try {
            ActivityInfo activityInfo = AppGlobals.getPackageManager().getActivityInfo(this.componentName, 0L, this.userId);
            return activityInfo == null ? AppGlobals.getPackageManager().getServiceInfo(this.componentName, 0L, this.userId) : activityInfo;
