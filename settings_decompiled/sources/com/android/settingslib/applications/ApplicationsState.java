...
public class ApplicationsState {
    ...
    public static final AppFilter FILTER_PERSONAL = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.5
        ...
        public void init(Context context) {
            ...
            this.mCloneUser = ApplicationsState.getCloneUserId(context);
        ...
        public boolean filterApp(AppEntry appEntry) {
            ...
            return userId == this.mCurrentUser || ((i = this.mCloneUser) != -1 && userId == i && this.mSupportAppClone.contains(appEntry.info.packageName));
        }
    };
    ...
    public static final AppFilter FILTER_WORK = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.7
        ...
        public boolean filterApp(AppEntry appEntry) {
            int userId = UserHandle.getUserId(appEntry.info.uid);
            return (userId == this.mCurrentUser || userId == this.mCloneUser) ? false : true;
        }
    };
    ...
    public static final AppFilter UNISOC_FILTER_THIRD_PARTY = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.11
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public void init() {
        }
        ...
        @Override // com.android.settingslib.applications.ApplicationsState.AppFilter
        public boolean filterApp(AppEntry appEntry) {
            return (appEntry.info.flags & 129) == 0;
        }
    };
    ...
    public static final AppFilter FILTER_EVERYTHING = new AppFilter() { // from class: com.android.settingslib.applications.ApplicationsState.15
        ...
        public boolean filterApp(AppEntry appEntry) {
            int userId = UserHandle.getUserId(appEntry.info.uid);
            int i = this.mCloneUser;
            return userId != i || (userId == i && this.mSupportAppClone.contains(appEntry.info.packageName));
        }
    };
        ...
        synchronized (this.mEntriesMap) {
            ...
            if (appEntry == null) {
                ...
                if (appInfoLocked == null) {
                    try {
                        appInfoLocked = this.mIpm.getApplicationInfo(str, 0L, i);
    ...
    public static class AppEntry extends SizeInfo {
        ...
        boolean ensureIconLocked(Context context) {
            ...
            if (this.icon == null) {
                ...
                this.mounted = false;
                this.icon = context.getDrawable(17303687);
