...
import com.unisoc.settings.timerpower.Alarms;
...
public class MainClearConfirm extends InstrumentedFragment {
    ...
    private View.OnClickListener mFinalClickListener = new View.OnClickListener() { // from class: com.android.settings.MainClearConfirm.1
        ...
        public void onClick(View view) {
            IpcObj.getInstance().setCmd(0, 38, new int[0]);
    ...
    private void resetData() {
        ...
        if (activity.getResources().getBoolean(R$bool.config_support_scheduledPowerOnOff)) {
            Alarms.resetAlarmStates(activity);
        }
        Calendar calendar = Calendar.getInstance();
        calendar.set(2008, 0, 1, 0, 0, 0);
        ((AlarmManager) activity.getSystemService("alarm")).setTime(calendar.getTimeInMillis());
    }
