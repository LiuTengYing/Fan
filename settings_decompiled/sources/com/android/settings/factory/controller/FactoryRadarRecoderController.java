...
public class FactoryRadarRecoderController extends AbstractPreferenceController implements LifecycleObserver, Preference.OnPreferenceChangeListener {
    private boolean isChecked;
    private RestrictedSwitchPreference mPreference;

    @Override // com.android.settingslib.core.AbstractPreferenceController
    public String getPreferenceKey() {
        return "radartoRecorder";
    }
    ...
    public FactoryRadarRecoderController(Context context, Lifecycle lifecycle) {
        super(context);
        if (lifecycle == null) {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        boolean z = SystemProperties.getBoolean("persist.fyt.radarToRecorder_enable", false);
        this.isChecked = z;
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        if (booleanValue) {
            SystemProperties.set("persist.fyt.radarToRecorder_enable", "true");
    ...
    public void setChecked(boolean z) {
        this.isChecked = z;
        this.mPreference.setChecked(z);
        UpdateStateChange.getInstance().updateChoice("radartofront", "recorder");
    }
