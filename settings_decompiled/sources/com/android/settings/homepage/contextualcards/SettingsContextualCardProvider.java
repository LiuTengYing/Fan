...
public class SettingsContextualCardProvider extends ContextualCardProvider {
    ...
    public ContextualCardProto$ContextualCardList getContextualCards() {
        ...
        return ContextualCardProto$ContextualCardList.newBuilder().addCard(cardName.setCardCategory(category).build()).addCard(newBuilder2.setSliceUri(uri2.toString()).setCardName(uri2.toString()).setCardCategory(category).build()).addCard(newBuilder3.setSliceUri(uri3.toString()).setCardName(uri3.toString()).setCardCategory(category).build()).addCard(newBuilder4.setSliceUri(uri4.toString()).setCardName(uri4.toString()).setCardCategory(category).build()).addCard(cardName2.setCardCategory(category2).build()).addCard(newBuilder5.setSliceUri(uri6.toString()).setCardName(uri6.toString()).setCardCategory(category2).build()).addCard(newBuilder6.setSliceUri(uri7.toString()).setCardName(uri7.toString()).setCardCategory(category).build()).build();
    }
}
