...
public class SliceBuilderUtils {
    ...
    public static Intent buildSearchResultPageIntent(Context context, String str, String str2, String str3, int i, int i2) {
        ...
        intent.putExtra(":settings:fragment_args_key", str2).putExtra("is_from_slice", true).putExtra("android.provider.extra.SETTINGS_EMBEDDED_DEEP_LINK_HIGHLIGHT_MENU_KEY", str4).setAction("com.android.settings.SEARCH_RESULT_TRAMPOLINE").setComponent(null);
    ...
    public static Intent getContentIntent(Context context, SliceData sliceData) {
        ...
        Intent buildSearchResultPageIntent = buildSearchResultPageIntent(context, sliceData.getFragmentClassName(), sliceData.getKey(), TextUtils.isEmpty(sliceData.getScreenTitle()) ? null : sliceData.getScreenTitle().toString(), 0, sliceData.getHighlightMenuRes());
