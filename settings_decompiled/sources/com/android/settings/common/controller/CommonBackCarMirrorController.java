...
public class CommonBackCarMirrorController extends AbstractPreferenceController implements LifecycleObserver, Preference.OnPreferenceChangeListener {
    private boolean isChecked;
    private RestrictedSwitchPreference mPreference;

    @Override // com.android.settingslib.core.AbstractPreferenceController
    public String getPreferenceKey() {
        return "reverse_mirror";
    }
    ...
    public CommonBackCarMirrorController(Context context, Lifecycle lifecycle) {
        super(context);
        if (lifecycle == null) {
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        IpcObj.getInstance().setCmd(0, 7, booleanValue ? 1 : 0);
        SystemProperties.set("persist.syu.back.mirror", booleanValue ? "1" : "0");
