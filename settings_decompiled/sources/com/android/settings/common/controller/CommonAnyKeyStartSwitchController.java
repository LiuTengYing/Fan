...
public class CommonAnyKeyStartSwitchController extends AbstractPreferenceController implements LifecycleObserver, Preference.OnPreferenceChangeListener {
    private boolean isChecked;
    private RestrictedSwitchPreference mPreference;

    @Override // com.android.settingslib.core.AbstractPreferenceController
    public String getPreferenceKey() {
        return "any_key_poweron";
    }
    ...
    public CommonAnyKeyStartSwitchController(Context context, Lifecycle lifecycle) {
        super(context);
        if (lifecycle == null) {
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        IpcObj.getInstance().setCmd(0, 2, booleanValue ? 1 : 0);
