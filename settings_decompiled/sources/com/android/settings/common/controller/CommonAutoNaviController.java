...
public class CommonAutoNaviController extends AbstractPreferenceController implements LifecycleObserver, Preference.OnPreferenceChangeListener {
    private boolean isChecked;
    private RestrictedSwitchPreference mPreference;

    @Override // com.android.settingslib.core.AbstractPreferenceController
    public String getPreferenceKey() {
        return "auto_start_navi";
    }
    ...
    public CommonAutoNaviController(Context context, Lifecycle lifecycle) {
        super(context);
        if (lifecycle == null) {
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        IpcObj.getInstance().setCmd(0, 3, booleanValue ? 1 : 0);
