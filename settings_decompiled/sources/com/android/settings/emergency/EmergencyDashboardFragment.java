...
public class EmergencyDashboardFragment extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(R$xml.emergency_settings) { // from class: com.android.settings.emergency.EmergencyDashboardFragment.1
