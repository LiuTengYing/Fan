...
public class TextSeekBar extends View {
    ...
    public TextSeekBar(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            ...
            Log.d("TextSeekBar", "TextSeekBar: " + this.mThumbWith + " " + this.mThumbHeight + " textPaddingTop " + this.mTextPaddingTop + " textSize" + this.mTextSize);
        }
        init();
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        Log.d("TextSeekBar", "onMeasure: width " + max2 + " height " + max + " backHeight " + this.mBackgroundHeight);
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        Log.d("TextSeekBar", "onSizeChanged: " + this.mWidth + " height " + this.mHeight + " mBackHeight " + this.mBackgroundHeight + " mTop " + this.mBackgroundTop + " thumbWidth " + this.mThumbWith + " " + this.mBackgroundLeft + " " + this.mBackgroundBottom);
    }
    ...
    private boolean checkProgressBound(MotionEvent motionEvent) {
        ...
        return x >= f - ((float) this.mThumbLeft) && x <= ((f + this.mBackgroundWidth) + ((float) this.mThumbWith)) + this.padding;
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r7) {
        ...
        L15:
            ...
            return r4
        L2a:
            com.android.settings.widget.view.TextSeekBar$OnSeekBarChangeListener r7 = r6.mOnSeekBarChangeListener
            if (r7 == 0) goto L35
            boolean r0 = r6.mIsDragging
            if (r0 == 0) goto L35
        ...
        L41:
            ...
            java.lang.String r5 = "TextSeekBar"
        ...
        L80:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.settings.widget.view.TextSeekBar.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private void setAnimation(float f, float f2, int i) {
        ...
        this.progressAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.settings.widget.view.TextSeekBar.1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                TextSeekBar.this.padding = ((Float) valueAnimator.getAnimatedValue()).floatValue();
            }
        });
