...
public class TextSeekBarCenter extends View {
    ...
    public interface OnSeekBarChangeListener {
        void onProgressChanged(TextSeekBarCenter textSeekBarCenter, int i, boolean z);

        void onStartTrackingTouch(TextSeekBarCenter textSeekBarCenter);

        void onStopTrackingTouch(TextSeekBarCenter textSeekBarCenter);
    }

    public TextSeekBarCenter(Context context) {
        super(context);
        this.mProgress = 0;
    ...
    public TextSeekBarCenter(Context context, AttributeSet attributeSet) {
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r8) {
        ...
        L1b:
            ...
            if (r0 == 0) goto L85
            boolean r0 = r7.checkProgressBound(r8)
            if (r0 == 0) goto L85
            int r8 = r7.getProgress(r8)
            r7.setProgress(r8)
            r7.onProgressRefresh()
            return r5
        L30:
            com.android.settings.widget.view.TextSeekBarCenter$OnSeekBarChangeListener r8 = r7.mOnSeekBarChangeListener
            if (r8 == 0) goto L3b
            boolean r0 = r7.mIsDragging
            if (r0 == 0) goto L3b
        ...
        L46:
            ...
            r0.append(r1)
            boolean r1 = r7.checkProgressBound(r8)
            r0.append(r1)
            float r1 = r8.getX()
            r0.append(r1)
            java.lang.String r0 = r0.toString()
            java.lang.String r1 = "TextSeekBarCenter"
            android.util.Log.d(r1, r0)
            android.view.ViewParent r0 = r7.getParent()
            r0.requestDisallowInterceptTouchEvent(r5)
            boolean r8 = r7.checkProgressBound(r8)
            if (r8 == 0) goto L85
            r7.mIsDragging = r5
            com.android.settings.widget.view.TextSeekBarCenter$OnSeekBarChangeListener r8 = r7.mOnSeekBarChangeListener
            if (r8 == 0) goto L7d
        ...
        L7d:
            r7.isTouch = r5
            r7.setAnimation(r3, r4, r2)
            r7.invalidate()
        L85:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.settings.widget.view.TextSeekBarCenter.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private void setAnimation(float f, float f2, int i) {
        ...
        this.progressAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.settings.widget.view.TextSeekBarCenter.1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                TextSeekBarCenter.this.padding = ((Float) valueAnimator.getAnimatedValue()).floatValue();
            }
        });
