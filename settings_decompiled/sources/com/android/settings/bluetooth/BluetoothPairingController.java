...
public class BluetoothPairingController implements CompoundButton.OnCheckedChangeListener {
    ...
    public boolean getContactSharingState() {
        ...
        if (phonebookAccessPermission != 1) {
            return phonebookAccessPermission != 2 && (bluetoothClass = this.mDevice.getBluetoothClass()) != null && bluetoothClass.getDeviceClass() == 1032 && 1 == this.mInitiator;
        }
        return true;
    }
    ...
    public void setContactSharingState() {
        ...
        if (phonebookAccessPermission == 1 || (phonebookAccessPermission == 0 && bluetoothClass != null && bluetoothClass.getDeviceClass() == 1032)) {
