...
public class SettingsInitialize extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        enableTwoPaneDeepLinkActivityIfNecessary(packageManager, context);
    }
    ...
    private void enableTwoPaneDeepLinkActivityIfNecessary(PackageManager packageManager, Context context) {
        ComponentName componentName = new ComponentName(context, DeepLinkHomepageActivity.class);
        ComponentName componentName2 = new ComponentName(context, SearchStateReceiver.class);
        int i = SplitController.getInstance().isSplitSupported() ? 1 : 2;
