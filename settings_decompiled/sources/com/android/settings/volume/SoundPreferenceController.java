...
public class SoundPreferenceController extends BasePreferenceController {
    ...
    public SoundPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public CharSequence getSummary() {
        return BidiFormatter.getInstance().unicodeWrap(this.mContext.getString(R$string.volume_settings_summary));
    }
}
